  ...
  return (
    <>
      <section className=" bg-me-one bg-cover bg-fixed ">
        <div className="  h-full dark:bg-black dark:bg-opacity-75   bg-gradient-to-t from-gray-300  py-52 ">
          ...
          <div className="p-10 py-10 text-center">
            ...
            <h3 className="py-2 font-one text-2xl dark:text-slate-100 md:text-4xl">
            ...
            <p className="text-md mx-auto max-w-xl py-5 font-two leading-8 text-gray-800 dark:text-yellow-100  md:text-xl  ">
              ...
              developer whose Looking for my first position as a developer.
              you're more than welcome to check out my projects.
            </p>
            <div className=" mx-auto flex max-w-lg  justify-center gap-10 rounded-3xl border-black bg-slate-200 bg-opacity-75 py-3 text-4xl text-slate-700 drop-shadow-2xl hover:drop-shadow-2xl dark:bg-slate-500 dark:text-gray-200">
